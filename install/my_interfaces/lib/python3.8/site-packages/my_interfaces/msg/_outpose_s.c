...
bool my_interfaces__msg__outpose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_interfaces.msg._outpose.Outpose", full_classname_dest, 34) == 0);
  }
  my_interfaces__msg__Outpose * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of Outpose */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_interfaces.msg._outpose");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Outpose");
