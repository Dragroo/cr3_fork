...
bool dobot_bringup_msg__msg__tool_vector_actual__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dobot_bringup_msg.msg._tool_vector_actual.ToolVectorActual", full_classname_dest, 58) == 0);
  }
  dobot_bringup_msg__msg__ToolVectorActual * ros_message = _ros_message;
  {  // x
...
PyObject * dobot_bringup_msg__msg__tool_vector_actual__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("dobot_bringup_msg.msg._tool_vector_actual");
