...
class Metaclass_EmergencyStop(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dobot_bringup_srv.srv.EmergencyStop')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from dobot_bringup_srv.srv import _emergency_stop
...
class EmergencyStop(metaclass=Metaclass_EmergencyStop):
    from dobot_bringup_srv.srv._emergency_stop import EmergencyStop_Request as Request
    from dobot_bringup_srv.srv._emergency_stop import EmergencyStop_Response as Response
