...
class Metaclass_Arc(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dobot_bringup_srv.srv import _arc
...
class Arc(metaclass=Metaclass_Arc):
    from dobot_bringup_srv.srv._arc import Arc_Request as Request
    from dobot_bringup_srv.srv._arc import Arc_Response as Response
