...
class Metaclass_JointMovJ(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dobot_bringup_srv.srv.JointMovJ')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from dobot_bringup_srv.srv import _joint_mov_j
...
class JointMovJ(metaclass=Metaclass_JointMovJ):
    from dobot_bringup_srv.srv._joint_mov_j import JointMovJ_Request as Request
    from dobot_bringup_srv.srv._joint_mov_j import JointMovJ_Response as Response
