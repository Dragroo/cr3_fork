...
class Metaclass_EnableRobot(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dobot_bringup_srv.srv.EnableRobot')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from dobot_bringup_srv.srv import _enable_robot
...
class EnableRobot(metaclass=Metaclass_EnableRobot):
    from dobot_bringup_srv.srv._enable_robot import EnableRobot_Request as Request
    from dobot_bringup_srv.srv._enable_robot import EnableRobot_Response as Response
