...
bool dobot_bringup_srv__srv__servo_j__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dobot_bringup_srv.srv._servo_j.ServoJ_Request", full_classname_dest, 45) == 0);
  }
  dobot_bringup_srv__srv__ServoJ_Request * ros_message = _ros_message;
  {  // j1
...
PyObject * dobot_bringup_srv__srv__servo_j__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("dobot_bringup_srv.srv._servo_j");
...
ROSIDL_GENERATOR_C_EXPORT
bool dobot_bringup_srv__srv__servo_j__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dobot_bringup_srv.srv._servo_j.ServoJ_Response", full_classname_dest, 46) == 0);
  }
  dobot_bringup_srv__srv__ServoJ_Response * ros_message = _ros_message;
  {  // res
