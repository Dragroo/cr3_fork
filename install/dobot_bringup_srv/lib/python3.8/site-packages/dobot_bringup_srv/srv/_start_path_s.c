...
bool dobot_bringup_srv__srv__start_path__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dobot_bringup_srv.srv._start_path.StartPath_Request", full_classname_dest, 51) == 0);
  }
  dobot_bringup_srv__srv__StartPath_Request * ros_message = _ros_message;
  {  // trace_name
...
PyObject * dobot_bringup_srv__srv__start_path__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("dobot_bringup_srv.srv._start_path");
...
ROSIDL_GENERATOR_C_EXPORT
bool dobot_bringup_srv__srv__start_path__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dobot_bringup_srv.srv._start_path.StartPath_Response", full_classname_dest, 52) == 0);
  }
  dobot_bringup_srv__srv__StartPath_Response * ros_message = _ros_message;
  {  // res
