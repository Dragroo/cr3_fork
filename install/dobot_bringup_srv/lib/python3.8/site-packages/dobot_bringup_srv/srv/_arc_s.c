...
bool dobot_bringup_srv__srv__arc__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dobot_bringup_srv.srv._arc.Arc_Request", full_classname_dest, 38) == 0);
  }
  dobot_bringup_srv__srv__Arc_Request * ros_message = _ros_message;
  {  // x1
...
PyObject * dobot_bringup_srv__srv__arc__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("dobot_bringup_srv.srv._arc");
...
ROSIDL_GENERATOR_C_EXPORT
bool dobot_bringup_srv__srv__arc__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dobot_bringup_srv.srv._arc.Arc_Response", full_classname_dest, 39) == 0);
  }
  dobot_bringup_srv__srv__Arc_Response * ros_message = _ros_message;
  {  // res
