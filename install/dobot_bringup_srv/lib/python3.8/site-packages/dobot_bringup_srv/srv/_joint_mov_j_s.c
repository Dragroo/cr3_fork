...
bool dobot_bringup_srv__srv__joint_mov_j__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dobot_bringup_srv.srv._joint_mov_j.JointMovJ_Request", full_classname_dest, 52) == 0);
  }
  dobot_bringup_srv__srv__JointMovJ_Request * ros_message = _ros_message;
  {  // j1
...
PyObject * dobot_bringup_srv__srv__joint_mov_j__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("dobot_bringup_srv.srv._joint_mov_j");
...
ROSIDL_GENERATOR_C_EXPORT
bool dobot_bringup_srv__srv__joint_mov_j__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dobot_bringup_srv.srv._joint_mov_j.JointMovJ_Response", full_classname_dest, 53) == 0);
  }
  dobot_bringup_srv__srv__JointMovJ_Response * ros_message = _ros_message;
  {  // res
