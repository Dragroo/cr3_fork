...
{
  new (message_memory) dobot_bringup_msg::msg::ToolVectorActual(_init);
}

void ToolVectorActual_fini_function(void * message_memory)
{
  auto typed_message = static_cast<dobot_bringup_msg::msg::ToolVectorActual *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ToolVectorActual_message_member_array[6] = {
  {
    ...
    offsetof(dobot_bringup_msg::msg::ToolVectorActual, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dobot_bringup_msg::msg::ToolVectorActual, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dobot_bringup_msg::msg::ToolVectorActual, z),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dobot_bringup_msg::msg::ToolVectorActual, rx),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dobot_bringup_msg::msg::ToolVectorActual, ry),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dobot_bringup_msg::msg::ToolVectorActual, rz),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ToolVectorActual_message_members = {
  "dobot_bringup_msg::msg",  // message namespace
  "ToolVectorActual",  // message name
  6,  // number of fields
  sizeof(dobot_bringup_msg::msg::ToolVectorActual),
...
{
  return &::dobot_bringup_msg::msg::rosidl_typesupport_introspection_cpp::ToolVectorActual_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dobot_bringup_msg, msg, ToolVectorActual)() {
  return &::dobot_bringup_msg::msg::rosidl_typesupport_introspection_cpp::ToolVectorActual_message_type_support_handle;
}
