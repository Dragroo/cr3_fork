...
class Metaclass_DisableRobot(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dobot_bringup_srv.srv.DisableRobot')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from dobot_bringup_srv.srv import _disable_robot
...
class DisableRobot(metaclass=Metaclass_DisableRobot):
    from dobot_bringup_srv.srv._disable_robot import DisableRobot_Request as Request
    from dobot_bringup_srv.srv._disable_robot import DisableRobot_Response as Response
