...
class SetArmOrientation_Request(metaclass=Metaclass_SetArmOrientation_Request):
    ...
    def lorr(self, value):
        if __debug__:
            ...
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'lorr' field must be an integer in [-9223372036854775808, 9223372036854775807]"
        self._lorr = value
    ...
    def uord(self, value):
        if __debug__:
            ...
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'uord' field must be an integer in [-9223372036854775808, 9223372036854775807]"
        self._uord = value
    ...
    def forn(self, value):
        if __debug__:
            ...
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'forn' field must be an integer in [-9223372036854775808, 9223372036854775807]"
        self._forn = value
    ...
    def config6(self, value):
        if __debug__:
            ...
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'config6' field must be an integer in [-9223372036854775808, 9223372036854775807]"
        self._config6 = value
...
class SetArmOrientation_Response(metaclass=Metaclass_SetArmOrientation_Response):
    ...
    def res(self, value):
        if __debug__:
            ...
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'res' field must be an integer in [-9223372036854775808, 9223372036854775807]"
        self._res = value
...
class Metaclass_SetArmOrientation(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dobot_bringup_srv.srv.SetArmOrientation')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from dobot_bringup_srv.srv import _set_arm_orientation
...
class SetArmOrientation(metaclass=Metaclass_SetArmOrientation):
    from dobot_bringup_srv.srv._set_arm_orientation import SetArmOrientation_Request as Request
    from dobot_bringup_srv.srv._set_arm_orientation import SetArmOrientation_Response as Response
