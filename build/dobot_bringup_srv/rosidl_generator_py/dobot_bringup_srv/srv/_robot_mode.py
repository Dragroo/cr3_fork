...
class Metaclass_RobotMode(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dobot_bringup_srv.srv.RobotMode')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from dobot_bringup_srv.srv import _robot_mode
...
class RobotMode(metaclass=Metaclass_RobotMode):
    from dobot_bringup_srv.srv._robot_mode import RobotMode_Request as Request
    from dobot_bringup_srv.srv._robot_mode import RobotMode_Response as Response
