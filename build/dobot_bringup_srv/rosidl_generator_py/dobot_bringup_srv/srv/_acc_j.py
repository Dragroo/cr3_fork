...
class Metaclass_AccJ(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dobot_bringup_srv.srv import _acc_j
...
class AccJ(metaclass=Metaclass_AccJ):
    from dobot_bringup_srv.srv._acc_j import AccJ_Request as Request
    from dobot_bringup_srv.srv._acc_j import AccJ_Response as Response
