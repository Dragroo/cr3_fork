...
#ifndef DOBOT_BRINGUP_SRV__SRV__DETAIL__SYNC__FUNCTIONS_H_
#define DOBOT_BRINGUP_SRV__SRV__DETAIL__SYNC__FUNCTIONS_H_
 ...
 * calls
 * dobot_bringup_srv__srv__Sync_Request__init().
...
/**
 * It calls
 * dobot_bringup_srv__srv__Sync_Request__fini()
 ...
 * dobot_bringup_srv__srv__Sync_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * dobot_bringup_srv__srv__Sync_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dobot_bringup_srv__srv__Sync_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dobot_bringup_srv
...
/**
 * It calls
 * dobot_bringup_srv__srv__Sync_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_dobot_bringup_srv
...
/**
 * It allocates the memory for the array and calls
 * dobot_bringup_srv__srv__Sync_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dobot_bringup_srv
...
/**
 * It calls
 * dobot_bringup_srv__srv__Sync_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DOBOT_BRINGUP_SRV__SRV__DETAIL__SYNC__FUNCTIONS_H_
