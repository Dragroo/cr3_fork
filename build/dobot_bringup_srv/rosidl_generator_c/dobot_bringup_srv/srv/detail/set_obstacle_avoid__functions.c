...
dobot_bringup_srv__srv__SetObstacleAvoid_Request__create()
{
  ...
  dobot_bringup_srv__srv__SetObstacleAvoid_Request * msg = (dobot_bringup_srv__srv__SetObstacleAvoid_Request *)allocator.allocate(sizeof(dobot_bringup_srv__srv__SetObstacleAvoid_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(dobot_bringup_srv__srv__SetObstacleAvoid_Request));
  bool success = dobot_bringup_srv__srv__SetObstacleAvoid_Request__init(msg);
  if (!success) {
...
dobot_bringup_srv__srv__SetObstacleAvoid_Request__destroy(dobot_bringup_srv__srv__SetObstacleAvoid_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    dobot_bringup_srv__srv__SetObstacleAvoid_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
dobot_bringup_srv__srv__SetObstacleAvoid_Request__Sequence__init(dobot_bringup_srv__srv__SetObstacleAvoid_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dobot_bringup_srv__srv__SetObstacleAvoid_Request * data = NULL;

  if (size) {
    data = (dobot_bringup_srv__srv__SetObstacleAvoid_Request *)allocator.zero_allocate(size, sizeof(dobot_bringup_srv__srv__SetObstacleAvoid_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = dobot_bringup_srv__srv__SetObstacleAvoid_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        dobot_bringup_srv__srv__SetObstacleAvoid_Request__fini(&data[i - 1]);
      }
...
dobot_bringup_srv__srv__SetObstacleAvoid_Request__Sequence__fini(dobot_bringup_srv__srv__SetObstacleAvoid_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      dobot_bringup_srv__srv__SetObstacleAvoid_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dobot_bringup_srv__srv__SetObstacleAvoid_Request__Sequence * array = (dobot_bringup_srv__srv__SetObstacleAvoid_Request__Sequence *)allocator.allocate(sizeof(dobot_bringup_srv__srv__SetObstacleAvoid_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = dobot_bringup_srv__srv__SetObstacleAvoid_Request__Sequence__init(array, size);
  if (!success) {
...
dobot_bringup_srv__srv__SetObstacleAvoid_Request__Sequence__destroy(dobot_bringup_srv__srv__SetObstacleAvoid_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    dobot_bringup_srv__srv__SetObstacleAvoid_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
dobot_bringup_srv__srv__SetObstacleAvoid_Request__Sequence__are_equal(const dobot_bringup_srv__srv__SetObstacleAvoid_Request__Sequence * lhs, const dobot_bringup_srv__srv__SetObstacleAvoid_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!dobot_bringup_srv__srv__SetObstacleAvoid_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  dobot_bringup_srv__srv__SetObstacleAvoid_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(dobot_bringup_srv__srv__SetObstacleAvoid_Request);
    dobot_bringup_srv__srv__SetObstacleAvoid_Request * data =
      (dobot_bringup_srv__srv__SetObstacleAvoid_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!dobot_bringup_srv__srv__SetObstacleAvoid_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          dobot_bringup_srv__srv__SetObstacleAvoid_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!dobot_bringup_srv__srv__SetObstacleAvoid_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dobot_bringup_srv__srv__SetObstacleAvoid_Response * msg = (dobot_bringup_srv__srv__SetObstacleAvoid_Response *)allocator.allocate(sizeof(dobot_bringup_srv__srv__SetObstacleAvoid_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(dobot_bringup_srv__srv__SetObstacleAvoid_Response));
  bool success = dobot_bringup_srv__srv__SetObstacleAvoid_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
dobot_bringup_srv__srv__SetObstacleAvoid_Response__destroy(dobot_bringup_srv__srv__SetObstacleAvoid_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    dobot_bringup_srv__srv__SetObstacleAvoid_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
dobot_bringup_srv__srv__SetObstacleAvoid_Response__Sequence__init(dobot_bringup_srv__srv__SetObstacleAvoid_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dobot_bringup_srv__srv__SetObstacleAvoid_Response * data = NULL;

  if (size) {
    data = (dobot_bringup_srv__srv__SetObstacleAvoid_Response *)allocator.zero_allocate(size, sizeof(dobot_bringup_srv__srv__SetObstacleAvoid_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = dobot_bringup_srv__srv__SetObstacleAvoid_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        dobot_bringup_srv__srv__SetObstacleAvoid_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
dobot_bringup_srv__srv__SetObstacleAvoid_Response__Sequence__fini(dobot_bringup_srv__srv__SetObstacleAvoid_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      dobot_bringup_srv__srv__SetObstacleAvoid_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  dobot_bringup_srv__srv__SetObstacleAvoid_Response__Sequence * array = (dobot_bringup_srv__srv__SetObstacleAvoid_Response__Sequence *)allocator.allocate(sizeof(dobot_bringup_srv__srv__SetObstacleAvoid_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = dobot_bringup_srv__srv__SetObstacleAvoid_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
dobot_bringup_srv__srv__SetObstacleAvoid_Response__Sequence__destroy(dobot_bringup_srv__srv__SetObstacleAvoid_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    dobot_bringup_srv__srv__SetObstacleAvoid_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
dobot_bringup_srv__srv__SetObstacleAvoid_Response__Sequence__are_equal(const dobot_bringup_srv__srv__SetObstacleAvoid_Response__Sequence * lhs, const dobot_bringup_srv__srv__SetObstacleAvoid_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!dobot_bringup_srv__srv__SetObstacleAvoid_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  dobot_bringup_srv__srv__SetObstacleAvoid_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(dobot_bringup_srv__srv__SetObstacleAvoid_Response);
    dobot_bringup_srv__srv__SetObstacleAvoid_Response * data =
      (dobot_bringup_srv__srv__SetObstacleAvoid_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!dobot_bringup_srv__srv__SetObstacleAvoid_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          dobot_bringup_srv__srv__SetObstacleAvoid_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!dobot_bringup_srv__srv__SetObstacleAvoid_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
