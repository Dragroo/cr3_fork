...
static const _ToolDO_Request_type_support_symbol_names_t _ToolDO_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dobot_bringup_srv, srv, ToolDO_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dobot_bringup_srv, srv, ToolDO_Request)),
  }
};
...
{
  return &::dobot_bringup_srv::srv::rosidl_typesupport_cpp::ToolDO_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dobot_bringup_srv, srv, ToolDO_Request)() {
  return get_message_type_support_handle<dobot_bringup_srv::srv::ToolDO_Request>();
}
...
static const _ToolDO_Response_type_support_symbol_names_t _ToolDO_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dobot_bringup_srv, srv, ToolDO_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dobot_bringup_srv, srv, ToolDO_Response)),
  }
};
...
{
  return &::dobot_bringup_srv::srv::rosidl_typesupport_cpp::ToolDO_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dobot_bringup_srv, srv, ToolDO_Response)() {
  return get_message_type_support_handle<dobot_bringup_srv::srv::ToolDO_Response>();
}
...
static const _ToolDO_type_support_symbol_names_t _ToolDO_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dobot_bringup_srv, srv, ToolDO)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dobot_bringup_srv, srv, ToolDO)),
  }
};
...
{
  return &::dobot_bringup_srv::srv::rosidl_typesupport_cpp::ToolDO_service_type_support_handle;
}
