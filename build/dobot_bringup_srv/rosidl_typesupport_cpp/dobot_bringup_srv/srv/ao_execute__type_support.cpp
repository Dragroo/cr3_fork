...
static const _AOExecute_Request_type_support_symbol_names_t _AOExecute_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dobot_bringup_srv, srv, AOExecute_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dobot_bringup_srv, srv, AOExecute_Request)),
  }
};
...
{
  return &::dobot_bringup_srv::srv::rosidl_typesupport_cpp::AOExecute_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dobot_bringup_srv, srv, AOExecute_Request)() {
  return get_message_type_support_handle<dobot_bringup_srv::srv::AOExecute_Request>();
}
...
static const _AOExecute_Response_type_support_symbol_names_t _AOExecute_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dobot_bringup_srv, srv, AOExecute_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dobot_bringup_srv, srv, AOExecute_Response)),
  }
};
...
{
  return &::dobot_bringup_srv::srv::rosidl_typesupport_cpp::AOExecute_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dobot_bringup_srv, srv, AOExecute_Response)() {
  return get_message_type_support_handle<dobot_bringup_srv::srv::AOExecute_Response>();
}
...
static const _AOExecute_type_support_symbol_names_t _AOExecute_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dobot_bringup_srv, srv, AOExecute)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dobot_bringup_srv, srv, AOExecute)),
  }
};
...
{
  return &::dobot_bringup_srv::srv::rosidl_typesupport_cpp::AOExecute_service_type_support_handle;
}
