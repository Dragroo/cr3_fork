...
static const _JointMovJ_Request_type_support_symbol_names_t _JointMovJ_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dobot_bringup_srv, srv, JointMovJ_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dobot_bringup_srv, srv, JointMovJ_Request)),
  }
};
...
{
  return &::dobot_bringup_srv::srv::rosidl_typesupport_cpp::JointMovJ_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dobot_bringup_srv, srv, JointMovJ_Request)() {
  return get_message_type_support_handle<dobot_bringup_srv::srv::JointMovJ_Request>();
}
...
static const _JointMovJ_Response_type_support_symbol_names_t _JointMovJ_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dobot_bringup_srv, srv, JointMovJ_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dobot_bringup_srv, srv, JointMovJ_Response)),
  }
};
...
{
  return &::dobot_bringup_srv::srv::rosidl_typesupport_cpp::JointMovJ_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dobot_bringup_srv, srv, JointMovJ_Response)() {
  return get_message_type_support_handle<dobot_bringup_srv::srv::JointMovJ_Response>();
}
...
static const _JointMovJ_type_support_symbol_names_t _JointMovJ_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dobot_bringup_srv, srv, JointMovJ)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dobot_bringup_srv, srv, JointMovJ)),
  }
};
...
{
  return &::dobot_bringup_srv::srv::rosidl_typesupport_cpp::JointMovJ_service_type_support_handle;
}
