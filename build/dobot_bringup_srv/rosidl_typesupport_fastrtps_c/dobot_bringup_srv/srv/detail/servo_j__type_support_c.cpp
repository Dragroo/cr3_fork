...
#include "dobot_bringup_srv/srv/detail/servo_j__rosidl_typesupport_fastrtps_c.h"
...
using _ServoJ_Request__ros_msg_type = dobot_bringup_srv__srv__ServoJ_Request;
...
size_t get_serialized_size_dobot_bringup_srv__srv__ServoJ_Request(
  const void * untyped_ros_message,
...
static uint32_t _ServoJ_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dobot_bringup_srv__srv__ServoJ_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dobot_bringup_srv
size_t max_serialized_size_dobot_bringup_srv__srv__ServoJ_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_dobot_bringup_srv__srv__ServoJ_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_bringup_srv, srv, ServoJ_Request)() {
...
using _ServoJ_Response__ros_msg_type = dobot_bringup_srv__srv__ServoJ_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dobot_bringup_srv
size_t get_serialized_size_dobot_bringup_srv__srv__ServoJ_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ServoJ_Response__ros_msg_type * ros_message = static_cast<const _ServoJ_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_dobot_bringup_srv__srv__ServoJ_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dobot_bringup_srv
size_t max_serialized_size_dobot_bringup_srv__srv__ServoJ_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_dobot_bringup_srv__srv__ServoJ_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_bringup_srv, srv, ServoJ_Response)() {
...
// already included above
// #include "dobot_bringup_srv/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "dobot_bringup_srv/srv/servo_j.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_bringup_srv, srv, ServoJ)() {
