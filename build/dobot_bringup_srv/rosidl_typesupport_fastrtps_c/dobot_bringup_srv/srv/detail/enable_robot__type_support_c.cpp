...
#include "dobot_bringup_srv/srv/detail/enable_robot__rosidl_typesupport_fastrtps_c.h"
...
using _EnableRobot_Request__ros_msg_type = dobot_bringup_srv__srv__EnableRobot_Request;
...
size_t get_serialized_size_dobot_bringup_srv__srv__EnableRobot_Request(
  const void * untyped_ros_message,
...
static uint32_t _EnableRobot_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dobot_bringup_srv__srv__EnableRobot_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dobot_bringup_srv
size_t max_serialized_size_dobot_bringup_srv__srv__EnableRobot_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_dobot_bringup_srv__srv__EnableRobot_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_bringup_srv, srv, EnableRobot_Request)() {
...
using _EnableRobot_Response__ros_msg_type = dobot_bringup_srv__srv__EnableRobot_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dobot_bringup_srv
size_t get_serialized_size_dobot_bringup_srv__srv__EnableRobot_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _EnableRobot_Response__ros_msg_type * ros_message = static_cast<const _EnableRobot_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_dobot_bringup_srv__srv__EnableRobot_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dobot_bringup_srv
size_t max_serialized_size_dobot_bringup_srv__srv__EnableRobot_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_dobot_bringup_srv__srv__EnableRobot_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_bringup_srv, srv, EnableRobot_Response)() {
...
// already included above
// #include "dobot_bringup_srv/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "dobot_bringup_srv/srv/enable_robot.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_bringup_srv, srv, EnableRobot)() {
