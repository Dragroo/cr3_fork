...
#include "dobot_bringup_srv/srv/detail/circle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dobot_bringup_srv::srv::Circle_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dobot_bringup_srv::srv::Circle_Request & ros_message)
{
  // Member: count
  cdr >> ros_message.count;
...
{
  auto typed_message =
    static_cast<const dobot_bringup_srv::srv::Circle_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dobot_bringup_srv::srv::Circle_Request *>(
    untyped_ros_message);
...
{
  return max_serialized_size_Circle_Request(full_bounded, 0);
}
...
{
  return &dobot_bringup_srv::srv::typesupport_fastrtps_cpp::_Circle_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dobot_bringup_srv, srv, Circle_Request)() {
  return &dobot_bringup_srv::srv::typesupport_fastrtps_cpp::_Circle_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dobot_bringup_srv
cdr_serialize(
  const dobot_bringup_srv::srv::Circle_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: res
  cdr << ros_message.res;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dobot_bringup_srv::srv::Circle_Response & ros_message)
{
  // Member: res
  cdr >> ros_message.res;
...
{
  auto typed_message =
    static_cast<const dobot_bringup_srv::srv::Circle_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<dobot_bringup_srv::srv::Circle_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return max_serialized_size_Circle_Response(full_bounded, 0);
}
...
{
  return &dobot_bringup_srv::srv::typesupport_fastrtps_cpp::_Circle_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dobot_bringup_srv, srv, Circle_Response)() {
  return &dobot_bringup_srv::srv::typesupport_fastrtps_cpp::_Circle_Response__handle;
}
...
{
  return &dobot_bringup_srv::srv::typesupport_fastrtps_cpp::_Circle__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dobot_bringup_srv, srv, Circle)() {
  return &dobot_bringup_srv::srv::typesupport_fastrtps_cpp::_Circle__handle;
}
