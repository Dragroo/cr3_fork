...
#include "dobot_bringup_srv/srv/detail/speed_j__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const dobot_bringup_srv::srv::SpeedJ_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dobot_bringup_srv::srv::SpeedJ_Request *>(
    untyped_ros_message);
...
{
  return max_serialized_size_SpeedJ_Request(full_bounded, 0);
}
...
{
  return &dobot_bringup_srv::srv::typesupport_fastrtps_cpp::_SpeedJ_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const dobot_bringup_srv::srv::SpeedJ_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<dobot_bringup_srv::srv::SpeedJ_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return max_serialized_size_SpeedJ_Response(full_bounded, 0);
}
...
{
  return &dobot_bringup_srv::srv::typesupport_fastrtps_cpp::_SpeedJ_Response__handle;
}
...
{
  return &dobot_bringup_srv::srv::typesupport_fastrtps_cpp::_SpeedJ__handle;
}
