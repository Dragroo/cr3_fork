...
static const _ServoJ_Request_type_support_symbol_names_t _ServoJ_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_bringup_srv, srv, ServoJ_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_bringup_srv, srv, ServoJ_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dobot_bringup_srv, srv, ServoJ_Request)() {
  return &::dobot_bringup_srv::srv::rosidl_typesupport_c::ServoJ_Request_message_type_support_handle;
}
...
static const _ServoJ_Response_type_support_symbol_names_t _ServoJ_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_bringup_srv, srv, ServoJ_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_bringup_srv, srv, ServoJ_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_dobot_bringup_srv
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dobot_bringup_srv, srv, ServoJ_Response)() {
  return &::dobot_bringup_srv::srv::rosidl_typesupport_c::ServoJ_Response_message_type_support_handle;
}
...
static const _ServoJ_type_support_symbol_names_t _ServoJ_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_bringup_srv, srv, ServoJ)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_bringup_srv, srv, ServoJ)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, dobot_bringup_srv, srv, ServoJ)() {
  return &::dobot_bringup_srv::srv::rosidl_typesupport_c::ServoJ_service_type_support_handle;
}
