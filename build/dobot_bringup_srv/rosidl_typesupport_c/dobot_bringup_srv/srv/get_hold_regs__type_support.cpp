...
static const _GetHoldRegs_Request_type_support_symbol_names_t _GetHoldRegs_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_bringup_srv, srv, GetHoldRegs_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_bringup_srv, srv, GetHoldRegs_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dobot_bringup_srv, srv, GetHoldRegs_Request)() {
  return &::dobot_bringup_srv::srv::rosidl_typesupport_c::GetHoldRegs_Request_message_type_support_handle;
}
...
static const _GetHoldRegs_Response_type_support_symbol_names_t _GetHoldRegs_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_bringup_srv, srv, GetHoldRegs_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_bringup_srv, srv, GetHoldRegs_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_dobot_bringup_srv
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dobot_bringup_srv, srv, GetHoldRegs_Response)() {
  return &::dobot_bringup_srv::srv::rosidl_typesupport_c::GetHoldRegs_Response_message_type_support_handle;
}
...
static const _GetHoldRegs_type_support_symbol_names_t _GetHoldRegs_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_bringup_srv, srv, GetHoldRegs)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_bringup_srv, srv, GetHoldRegs)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, dobot_bringup_srv, srv, GetHoldRegs)() {
  return &::dobot_bringup_srv::srv::rosidl_typesupport_c::GetHoldRegs_service_type_support_handle;
}
