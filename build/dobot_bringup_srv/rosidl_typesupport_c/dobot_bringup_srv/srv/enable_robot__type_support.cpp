...
static const _EnableRobot_Request_type_support_symbol_names_t _EnableRobot_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_bringup_srv, srv, EnableRobot_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_bringup_srv, srv, EnableRobot_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dobot_bringup_srv, srv, EnableRobot_Request)() {
  return &::dobot_bringup_srv::srv::rosidl_typesupport_c::EnableRobot_Request_message_type_support_handle;
}
...
static const _EnableRobot_Response_type_support_symbol_names_t _EnableRobot_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_bringup_srv, srv, EnableRobot_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_bringup_srv, srv, EnableRobot_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_dobot_bringup_srv
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dobot_bringup_srv, srv, EnableRobot_Response)() {
  return &::dobot_bringup_srv::srv::rosidl_typesupport_c::EnableRobot_Response_message_type_support_handle;
}
...
static const _EnableRobot_type_support_symbol_names_t _EnableRobot_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_bringup_srv, srv, EnableRobot)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_bringup_srv, srv, EnableRobot)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, dobot_bringup_srv, srv, EnableRobot)() {
  return &::dobot_bringup_srv::srv::rosidl_typesupport_c::EnableRobot_service_type_support_handle;
}
