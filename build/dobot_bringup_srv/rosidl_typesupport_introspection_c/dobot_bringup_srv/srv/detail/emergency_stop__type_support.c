...
#include <stddef.h>
#include "dobot_bringup_srv/srv/detail/emergency_stop__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  dobot_bringup_srv__srv__EmergencyStop_Request__init(message_memory);
}

void EmergencyStop_Request__rosidl_typesupport_introspection_c__EmergencyStop_Request_fini_function(void * message_memory)
{
  dobot_bringup_srv__srv__EmergencyStop_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember EmergencyStop_Request__rosidl_typesupport_introspection_c__EmergencyStop_Request_message_member_array[1] = {
  {
    ...
    offsetof(dobot_bringup_srv__srv__EmergencyStop_Request, structure_needs_at_least_one_member),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers EmergencyStop_Request__rosidl_typesupport_introspection_c__EmergencyStop_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(dobot_bringup_srv__srv__EmergencyStop_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_bringup_srv, srv, EmergencyStop_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  dobot_bringup_srv__srv__EmergencyStop_Response__init(message_memory);
}
...
{
  dobot_bringup_srv__srv__EmergencyStop_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember EmergencyStop_Response__rosidl_typesupport_introspection_c__EmergencyStop_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dobot_bringup_srv__srv__EmergencyStop_Response, res),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers EmergencyStop_Response__rosidl_typesupport_introspection_c__EmergencyStop_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(dobot_bringup_srv__srv__EmergencyStop_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_dobot_bringup_srv
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_bringup_srv, srv, EmergencyStop_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers dobot_bringup_srv__srv__detail__emergency_stop__rosidl_typesupport_introspection_c__EmergencyStop_service_members = {
  "dobot_bringup_srv__srv",  // service namespace
  "EmergencyStop",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // dobot_bringup_srv__srv__detail__emergency_stop__rosidl_typesupport_introspection_c__EmergencyStop_Request_message_type_support_handle,
  NULL  // response message
  // dobot_bringup_srv__srv__detail__emergency_stop__rosidl_typesupport_introspection_c__EmergencyStop_Response_message_type_support_handle
};

static rosidl_service_type_support_t dobot_bringup_srv__srv__detail__emergency_stop__rosidl_typesupport_introspection_c__EmergencyStop_service_type_support_handle = {
  0,
  &dobot_bringup_srv__srv__detail__emergency_stop__rosidl_typesupport_introspection_c__EmergencyStop_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_bringup_srv, srv, EmergencyStop)() {
  if (!dobot_bringup_srv__srv__detail__emergency_stop__rosidl_typesupport_introspection_c__EmergencyStop_service_type_support_handle.typesupport_identifier) {
    dobot_bringup_srv__srv__detail__emergency_stop__rosidl_typesupport_introspection_c__EmergencyStop_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)dobot_bringup_srv__srv__detail__emergency_stop__rosidl_typesupport_introspection_c__EmergencyStop_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_bringup_srv, srv, EmergencyStop_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_bringup_srv, srv, EmergencyStop_Response)()->data;
  }

  return &dobot_bringup_srv__srv__detail__emergency_stop__rosidl_typesupport_introspection_c__EmergencyStop_service_type_support_handle;
}
